package com.cybertek.javaReviews.oopHomeworkSolutions.q13;

import java.util.Arrays;

public class Color {
    //rgb array with 3 ints is used to hold r,g,b values
    private int[] rgb = new int[3]; // normally until now we had only one single variable as instance variable. However we can define Arrays as instance objects of this class
    ...
    public Color(){
        this.rgb = new int[]{255,255,255}; // sets as white
    }
    /**
    ...
    public String toString(){
        /*
        new int[]{255, 255, 255};  : Array
        rgb Array : How to check if two arrays are equal so I can return color code
         */
